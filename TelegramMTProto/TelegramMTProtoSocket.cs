...
{
    internal class TelegramMTProtoSocket : IDisposable
    {
        public IPEndPoint IPEndPoint { get => _ipEndPoint; }
        private readonly IPEndPoint _ipEndPoint;
        private readonly TelegramMTProtoPacket _mtprotoPacketTgSocket;
        private readonly TelegramMTProtoPacket _mtprotoPacketClientSocket;
        ...
        public TelegramMTProtoSocket(in Socket clientSocket)
        {
            _clientSocket = clientSocket;
            _mtprotoPacketTgSocket = new TelegramMTProtoPacket();
            _mtprotoPacketClientSocket = new TelegramMTProtoPacket();
        ...
        public void StartAsync(in byte[] buffer, in string secret)
        {
            if (_isDisposed)
            {
                Console.WriteLine("TelegramMTProtoSocket disposed");
                return;
            }
            ...
            _tgSocket = TelegramMTProtoSockets.GetSocket(dcId);
